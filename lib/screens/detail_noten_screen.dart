    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          ...
          builder: (ctx, snap) {
            ...
            try{
              markSubject = List<Map<String, dynamic>>.from(marksOfSubject[subjectName]);
            }catch(e){
              return const Center(child: Text('Keine Noten vorhanden.', style: TextStyle(color: Colors.white),),);
            }
